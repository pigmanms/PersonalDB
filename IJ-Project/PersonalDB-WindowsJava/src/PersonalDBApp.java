...
/**
 * archived_source_codes.PersonalDBApp — a Windows-friendly Java Swing/AWT desktop app for managing a personal database (SPPD).
 *
 ...
 *
 * No external libraries required. Compile with: javac archived_source_codes.PersonalDBApp.java
 * Run with: java archived_source_codes.PersonalDBApp
 */
        ...
        @Override public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
            ...
            if (columnIndex==0) {
                ...
                if (existing != null && existing != f) {
                    JOptionPane.showMessageDialog(PersonalDBApp.this, "이미 존재하는 필드 이름입니다.");
                    return;
                }
